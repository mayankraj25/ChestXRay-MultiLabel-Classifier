...
def diagnose(img_path):
    ...
    # 4. Check Gradients (The Math Check)
    backbone = model.layers[1] 
    output_layer = model.layers[5] # Adjust index if needed based on model.summary()
...
# RUN IT
diagnose("data/images/00000013_026.png") # Use the same image you tested